...
return {contentView: contentView, fileLength: fileLength, blockLength: blockLength, a: a, b: b, c: c};
  };

  uploadToServer = function(username, filename, content, serverUrl) {
    var fd = new FormData();
    fd.append(username, new Blob([content], {type: "application/octet-stream"} ), filename);
